...
import { bodyOutline, newspaperOutline, todayOutline } from 'ionicons/icons';
...
const App: React.FC = () => (
    <IonApp>
        <IonReactRouter>
            <IonMenu color='secondary' contentId='myactivity'>
                <IonHeader>
                    <IonToolbar>
                        <IonTitle size='large'>MyActivity</IonTitle>
                        <IonIcon color="dark" size='large' slot='start' icon={todayOutline}/>
                    </IonToolbar>
                </IonHeader>
                <IonContent>
                    <IonList>
